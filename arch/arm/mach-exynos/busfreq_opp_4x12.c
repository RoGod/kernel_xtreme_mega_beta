...
static struct busfreq_table exynos4_busfreq_table_orig[] = {
	{LV_0, 400266, 1087500, 0, 0, 0}, /* MIF : 400MHz INT : 200MHz */
 	{LV_1, 400200, 1087500, 0, 0, 0}, /* MIF : 400MHz INT : 200MHz */
 	{LV_2, 267200, 987500, 0, 0, 0},  /* MIF : 267MHz INT : 200MHz */
 	{LV_3, 267160, 987500, 0, 0, 0},  /* MIF : 267MHz INT : 160MHz */
 	{LV_4, 160160, 937500, 0, 0, 0},  /* MIF : 160MHz INT : 160MHz */
 	{LV_5, 133133, 937500, 0, 0, 0},  /* MIF : 133MHz INT : 133MHz */
 	{LV_6, 100100, 937500, 0, 0, 0},  /* MIF : 100MHz INT : 100MHz */
  };

static struct busfreq_table exynos4_busfreq_table_rev2[] = {
	{LV_0, 440293, 1087500, 0, 0, 0}, /* MIF : 440MHz INT : 220MHz */
 	{LV_1, 440220, 1087500, 0, 0, 0}, /* MIF : 440MHz INT : 220MHz */
 	{LV_2, 293220, 987500, 0, 0, 0},  /* MIF : 293MHz INT : 220MHz */
 	{LV_3, 293176, 987500, 0, 0, 0},  /* MIF : 293MHz INT : 176MHz */
 	{LV_4, 176176, 937500, 0, 0, 0},  /* MIF : 176MHz INT : 176MHz */
 	{LV_5, 147147, 937500, 0, 0, 0},  /* MIF : 147MHz INT : 147MHz */
 	{LV_6, 110110, 937500, 0, 0, 0},  /* MIF : 110MHz INT : 110MHz */
  };
...
static unsigned int exynos4212_mif_volt[PD_ASV_GROUP][LV_END] = {	
	...
	{1037500, 1037500,  987500,  987500, 937500, 937500, 937500}, /* RESERVED */
	{ 987500,  987500,  937500,  937500, 937500, 937500, 937500}, /* ASV1 */
	{ 987500,  987500,  937500,  937500, 937500, 937500, 937500}, /* ASV2 */
	{ 987500,  987500,  937500,  937500, 887500, 887500, 887500}, /* ASV3 */
	{ 987500,  987500,  937500,  937500, 887500, 887500, 887500}, /* ASV4 */
	{ 987500,  987500,  937500,  937500, 887500, 887500, 887500}, /* ASV5 */
	{ 987500,  987500,  937500,  937500, 887500, 887500, 887500}, /* ASV6 */
	{ 937500,  937500,  887500,  887500, 887500, 887500, 887500}, /* ASV7 */
	{ 937500,  937500,  887500,  887500, 887500, 887500, 837500}, /* ASV8 */
	{ 937500,  937500,  887500,  887500, 887500, 887500, 837500}, /* ASV9 */
	{ 937500,  937500,  887500,  887500, 887500, 837500, 837500}, /* ASV10 */
	{ 937500,  937500,  887500,  887500, 887500, 837500, 837500}, /* RESERVED */
	{ 937500,  937500,  887500,  887500, 887500, 837500, 837500}, /* RESERVED */
};

static unsigned int exynos4212_int_volt[PD_ASV_GROUP][LV_END] = {	
	/* 266      200       200     160    160      133     100 */
	{1087500, 1000000, 1000000, 962500, 962500, 925000, 912500}, /* RESERVED */	
	{1050000,  987500,  987500, 950000, 950000, 912500, 900000}, /* ASV1 */
	{1037500,  975000,  975000, 937500, 937500, 900000, 887500}, /* ASV2 */
	{1037500,  962500,  962500, 925000, 925000, 887500, 875000}, /* ASV3 */
	{1050000,  975000,  975000, 937500, 937500, 900000, 887500}, /* ASV4 */
	{1037500,  962500,  962500, 925000, 925000, 887500, 875000}, /* ASV5 */
	{1037500,  962500,  962500, 925000, 925000, 887500, 875000}, /* ASV6 */
	{1025000,  950000,  950000, 912500, 912500, 887500, 875000}, /* ASV7 */
	{1025000,  937500,  937500, 900000, 900000, 875000, 862500}, /* ASV8 */
	{1025000,  925000,  925000, 887500, 887500, 875000, 862500}, /* ASV9 */
	{1025000,  925000,  925000, 887500, 887500, 862500, 850000}, /* ASV10 */
	{1025000,  912500,  912500, 875000, 875000, 850000, 837500}, /* RESERVED */
	{1025000,  900000,  900000, 862500, 862500, 837500, 837500}, /* RESERVED */
};

static unsigned int exynos4412_mif_volt[ASV_GROUP][LV_END] = {
	/* 400      400      267      267      160     133     100 */
	{1087500, 1087500, 987500,  987500,  937500, 937500, 937500}, /* RESERVED */
	{1037500, 1037500, 937500,  937500,  887500, 887500, 887500}, /* RESERVED */
	{1037500, 1037500, 937500,  937500,  887500, 887500, 887500}, /* ASV2 */
	{1037500, 1037500, 937500,  937500,  887500, 887500, 887500}, /* ASV3 */
	{1037500, 1037500, 937500,  937500,  887500, 887500, 887500}, /* ASV4 */
	{ 987500,  987500, 937500,  937500,  887500, 887500, 887500}, /* ASV5 */
	{ 987500,  987500, 937500,  937500,  887500, 887500, 887500}, /* ASV6 */
	{ 987500,  987500, 937500,  937500,  887500, 887500, 887500}, /* ASV7 */
	{ 987500,  987500, 937500,  937500,  887500, 887500, 887500}, /* ASV8 */
	{ 987500,  987500, 937500,  937500,  887500, 887500, 837500}, /* ASV9 */
	{ 897500,  987500, 887500,  887500,  887500, 887500, 837500}, /* ASV10 */
	{ 987500,  987500, 887500,  887500,  887500, 887500, 837500}, /* RESERVED */
};
...
static unsigned int exynos4412_int_volt[ASV_GROUP][LV_END] = {
  /* GDR : 266       200      200     160    160      133     100 */
	...
	{1062500, 1012500, 1012500, 925000, 925000, 900000, 862500}, /* ASV2 */
	{1050000, 1000000, 1000000, 925000, 925000, 887500, 850000}, /* ASV3 */
	{1050000, 1000000, 1000000, 912500, 912500, 887500, 850000}, /* ASV4 */
	{1037500,  987500,  987500, 912500, 912500, 875000, 837500}, /* ASV5 */
	{1037500,  987500,  987500, 900000, 900000, 862500, 837500}, /* ASV6 */
	{1025000,  975000,  975000, 900000, 900000, 850000, 837500}, /* ASV7 */
	{1025000,  975000,  975000, 887500, 887500, 850000, 837500}, /* ASV8 */
	{1025000,  975000,  975000, 887500, 887500, 850000, 837500}, /* ASV9 */
	{1025000,  975000,  975000, 887500, 887500, 850000, 837500}, /* ASV10 */
	{1012500,  912500,  962500, 875000, 875000, 837500, 837500}, /* RESERVED */
};
...
static unsigned int exynos4412_mif_volt_rev2[PRIME_ASV_GROUP][LV_END] = {
	...
	{1137500, 1137500, 1037500, 1037500,  987500,  987500,  987500}, /* ASV0 */
	{1087500, 1087500,  987500,  987500,  937500,  937500,  937500}, /* ASV1 */
	{1087500, 1087500,  987500,  987500,  937500,  937500,  887500}, /* ASV2 */
	{1087500, 1087500,  987500,  987500,  937500,  937500,  887500}, /* ASV3 */
	{1037500, 1037500,  937500,  937500,  887500,  937500,  887500}, /* ASV4 */
	{1037500, 1037500,  937500,  937500,  887500,  887500,  887500}, /* ASV5 */
	{1037500, 1037500,  937500,  937500,  887500,  887500,  887500}, /* ASV6 */
	{1037500, 1037500,  937500,  937500,  887500,  887500,  837500}, /* ASV7 */
	{1037500, 1037500,  937500,  937500,  887500,  837500,  837500}, /* ASV8 */
	{ 987500,  987500,  887500,  887500,  837500,  837500,  837500}, /* ASV9 */
	{ 987500,  987500,  887500,  887500,  837500,  837500,  837500}, /* ASV10 */
	{ 987500,  987500,  887500,  887500,  837500,  837500,  837500}, /* ASV11 */
	{ 937500,  937500,  837500,  837500,  837500,  837500,  837500}, /* ASV12 */
};

/* 20120927 DVFS table for pega prime */
static unsigned int exynos4412_int_volt_rev2[PRIME_ASV_GROUP][LV_END] = {
  /* GDR : 293       220      220     176      176      147     110 */
	{1112500, 1087500, 1087500, 1025000, 1025000,  987500, 975000}, /* ASV0 */
	{1062500, 1037500, 1037500,  975000,  975000,  937500, 925000}, /* ASV1 */
	{1050000, 1025000, 1025000,  962500,  962500,  925000, 900000}, /* ASV2 */
	{1037500, 1025000, 1025000,  962500,  962500,  925000, 887500}, /* ASV3 */
	{1025000, 1012500, 1012500,  950000,  950000,  912500, 875000}, /* ASV4 */
	{1012500, 1000000, 1000000,  937500,  937500,  900000, 875000}, /* ASV5 */
	{1000000,  987500,  987500,  925000,  925000,  887500, 875000}, /* ASV6 */
	{ 987500,  975000,  975000,  912500,  912500,  875000, 862500}, /* ASV7 */
	{1025000,  962500,  962500,  900000,  900000,  862500, 862500}, /* ASV8 */
	{1012500,  950000,  950000,  887500,  887500,  862500, 862500}, /* ASV9 */
	{1000000,  925000,  925000,  862500,  862500,  837500, 837500}, /* ASV10 */
	{ 987500,  912500,  912500,  850000,  850000,  837500, 837500}, /* ASV11 */
	{ 987500,  900000,  900000,  837500,  837500,  837500, 837500}, /* ASV12 */
};
...
static unsigned int exynos4412_1ghz_mif_volt[ASV_GROUP][LV_END] = {
	...
	{1087500, 1087500, 987500,  987500, 937500, 937500, 937500}, /* RESERVED */
	{1037500, 1037500, 987500,  987500, 937500, 937500, 937500}, /* RESERVED */
	{1037500, 1037500, 987500,  987500, 937500, 937500, 937500}, /* ASV2 */
	{1037500, 1037500, 987500,  987500, 937500, 937500, 937500}, /* ASV3 */
	{1037500, 1037500, 937500,  937500, 887500, 887500, 887500}, /* ASV4 */
	{1037500, 1037500, 937500,  937500, 887500, 887500, 887500}, /* ASV5 */
	{1037500, 1037500, 937500,  937500, 887500, 887500, 887500}, /* ASV6 */
	{ 987500,  987500, 937500,  937500, 887500, 887500, 887500}, /* ASV7 */
	{ 987500,  987500, 937500,  937500, 887500, 887500, 887500}, /* ASV8 */
	{ 987500,  987500, 937500,  937500, 887500, 887500, 887500}, /* ASV9 */
	{ 987500,  987500, 937500,  937500, 887500, 887500, 887500}, /* ASV10 */
	{1012500, 1012500, 912500,  912500, 912500, 912500, 862500}, /* RESERVED */
};

static unsigned int exynos4412_1ghz_int_volt[ASV_GROUP][LV_END] = {
/* GDR : 266   200     200      160      160     133    100 */
	{0, 1075000, 1075000,  987500,  987500, 962500, 937500}, /* RESERVED */
	{0, 1037500, 1037500,  987500,  987500, 962500, 937500}, /* RESERVED */
	{0, 1037500, 1037500,  987500,  987500, 962500, 937500}, /* ASV2 */
	{0, 1037500, 1037500,  987500,  987500, 962500, 937500}, /* ASV3 */
	{0, 1025000, 1025000,  937500,  937500, 912500, 887500}, /* ASV4 */
	{0, 1025000, 1025000,  937500,  937500, 912500, 887500}, /* ASV5 */
	{0, 1025000, 1025000,  937500,  937500, 912500, 887500}, /* ASV6 */
	{0, 1000000, 1000000,  925000,  925000, 875000, 862500}, /* ASV7 */
	{0, 1000000, 1000000,  925000,  925000, 875000, 862500}, /* ASV8 */
	{0, 1000000, 1000000,  925000,  925000, 875000, 862500}, /* ASV9 */
	{0, 1000000, 1000000,  925000,  925000, 875000, 862500}, /* ASV10 */
	{0,  987500,  987500,  900000,  900000, 862500, 862500}, /* RESERVED */
};
