...
charge_ok:
	...
	case POWER_SUPPLY_TYPE_BATTERY:
		...
		info->recharge_phase = false;
 		...
 		printk("Thoth-Kernel: POWER_SUPPLY_TYPE_BATTERY\n");		
		break;
	case POWER_SUPPLY_TYPE_MAINS:
		charge_info_level = ac_level;
		sprintf(charge_info_text, "AC Charger");
		printk("Thoth-Kernel: POWER_SUPPLY_TYPE_MAINS, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_USB:
		...
		printk("Thoth-Kernel: POWER_SUPPLY_TYPE_USB, using charge rate %d mA\n", usb_level);
	...
	case POWER_SUPPLY_TYPE_USB_CDP:
		...
		sprintf(charge_info_text, "USB CDP Charger");
 		printk("Thoth-Kernel: POWER_SUPPLY_TYPE_USB_CDP, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_DOCK:
	    printk("Thoth-Kernel: POWER_SUPPLY_TYPE_DOCK\n");
		if (!info->pdata->suspend_chging)
			wake_lock(&info->charge_wake_lock);
		...
		case CABLE_TYPE_AUDIODOCK_MUIC:
		    charge_info_level = ac_level;
 			...
 			printk("Thoth-Kernel: CABLE_TYPE_AUDIODOCK_MUIC, using charge rate %d mA\n", ac_level);
		...
		case CABLE_TYPE_SMARTDOCK_TA_MUIC:
			if (info->cable_sub_type == ONLINE_SUB_TYPE_SMART_OTG) {
			    charge_info_level = ac_level;
 				...
 				printk("Thoth-Kernel: CABLE_TYPE_SMARTDOCK_TA_MUIC (with host), using charge rate %d mA\n", ac_level);
			    ...
			    charge_info_level = ac_level;
 				...
 				printk("Thoth-Kernel: CABLE_TYPE_SMARTDOCK_TA_MUIC (no host), using charge rate %d mA\n", ac_level);
		...
		case CABLE_TYPE_SMARTDOCK_USB_MUIC:
		    charge_info_level = ac_level;
 			...
 			printk("Thoth-Kernel: CABLE_TYPE_SMARTDOCK_USB_MUIC, using charge rate %d mA\n", ac_level);
		...
		default:
		    charge_info_level = ac_level;
 			...
 			printk("Thoth-Kernel: Default, using charge rate %d mA\n", ac_level);
	...
	case POWER_SUPPLY_TYPE_WIRELESS:
	    charge_info_level = wireless_level;
 		...
 		printk("Thoth-Kernel: POWER_SUPPLY_TYPE_WIRELESS, using charge rate %d mA\n", wireless_level);
