...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
			...
			/* step 0 */{160  ,1000000	, 862500   , 0   , 70},
			/* step 1 */{266  ,1000000	, 887500   ,62   , 90},
			/* step 2 */{350  ,1000000	, 937500   ,85   , 90},
			/* step 3 */{440  ,1000000	,1012500   ,85   , 90},
			/* step 4 */{533  ,1000000	,1062500   ,95   ,100} };
#else
			/* step 0 */{134  ,1000000	, 937500   ,85   , 90},
			/* step 1 */{267  ,1000000	,1037500   ,85   ,100} };
#endif
